...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        #self.characterLineEdit.textChanged.connect(self.on_text_changed)

        # initialize ui element connections
        #self.characterLineEdit.textChanged.connect(self.on_text_changed)
        #self.characterLabel.setText(f"# of Characters: {self.characterLineEdit.value()}")
